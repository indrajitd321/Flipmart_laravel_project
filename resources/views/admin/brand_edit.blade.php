...
<div class="content-header">
                    ...
                    <div class="leftside-content-header">
                        <ul class="breadcrumbs">
                            ...
                            <li><a href="javascript:avoid(0)">All Brands</a></li>
                    ...
                    @include('includes.message')
                     <div class="panel b-primary bt-md">
                        <div class="panel-content">
                            <div class="row">
                                <div class="col-xs-6"><h4>Brand Update Form</4></div>
                                <div class="col-xs-6 text-right">
                                    <a href="{{ route('manage-brand') }}" class="btn btn-primary">All Brands</a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <form class="form-horizontal" method="POST" action="{{ route('update-brand') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="id" value="{{ $row['id'] }}">
                                                <input type="text" class="form-control" name="brand_name" id="brand_name" value="{{ $row['brand_name'] }}" placeholder="Brand Name">
                                            </div>
                                        </div>
